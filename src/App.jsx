  ...
  const routers = createBrowserRouter([
    {
      path: '', element: <Layout clearUserData={clearUserData} crrUser={crrUser} />, children: [
        ...
        { path: 'Categories', element: <Categories name='mizoo' age='25' /> },
        ...
        { path: 'Payment', element: <CartContextProvider> <Payment /> </CartContextProvider> },
        { path: 'BrandsProducts/:id', element: <BrandsProducts /> },
        { path: 'ProductsDetails/:id', element: <ProtectedRoute> <CartContextProvider> <ProductDetails /> </CartContextProvider>  </ProtectedRoute> },
